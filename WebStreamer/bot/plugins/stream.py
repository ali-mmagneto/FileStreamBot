...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        stream_link = "https://atbanavidyobot2.onrender.com/{}/{}".format(log_msg.id, file_name) if Var.ON_HEROKU or Var.NO_PORT else \
            "http://atbanavidyobot2.onrender.com/{}/{}".format(log_msg.id,
                                    file_name)

        msg_text ="""
<i><u>Linkini Oluşturdum!</u></i>\n
<b>📂 Dosya Adı :</b> <i>{}</i>\n
<b>📦 Dosya Boyutu :</b> <i>{}</i>\n
<b>📥 İndirme Linki :</b> <i>{}</i>\n
<b>🚸 Not : Bu Link Süresizdir</b>\n
<i>© @mmagneto3</i>"""
        ...
        await m.reply_text(
            ...
            parse_mode=ParseMode.HTML, 
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Şimdi İndir 📥", url=stream_link)]]),
            quote=True
        )
