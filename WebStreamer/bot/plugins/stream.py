...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        stream_link = "https://atbanavidyobot.onrender.com/{}/{}".format(log_msg.id, file_name) if Var.ON_HEROKU or Var.NO_PORT else \
            "http://atbanavidyobot.onrender.com/{}/{}".format(log_msg.id,
                                    file_name)
